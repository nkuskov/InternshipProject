...
public class PlacesAutoCompleteAdapter
            ...
            PendingResult<AutocompletePredictionBuffer> results =
                    Places.GeoDataApi
                            .getAutocompletePredictions(mGoogleApiClient, constraint.toString(),
                                    toBounds(MapsActivity.getmLastLocation(),150), mPlaceFilter);
    ...
    public void onBindViewHolder(PredictionHolder mPredictionHolder, final int i) {
        mPredictionHolder.mPrediction.setText(mResultList.get(i).primaryPlace);
        mPredictionHolder.secodaryPlace.setText(mResultList.get(i).secondaryPlace);
    ...
    public class PredictionHolder extends RecyclerView.ViewHolder {
        ...
        private TextView secodaryPlace;
        public PredictionHolder(View itemView) {
            super(itemView);
            mPrediction = (TextView) itemView.findViewById(R.id.address);
            secodaryPlace = (TextView) itemView.findViewById(R.id.secondary_adress);
    ...
    public class PlaceAutocomplete {
        ...
        public CharSequence primaryPlace;
        public CharSequence secondaryPlace;
        ...
        public String toString() {
            return primaryPlace.toString();
        }
    }

    public LatLngBounds toBounds(Location location, double radius) {
